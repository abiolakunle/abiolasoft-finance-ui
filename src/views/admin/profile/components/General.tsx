    ...
    return (
        <Card mb={{ base: "0px", "2xl": "20px" }} {...rest}>
            ...
            <Text color={textColorSecondary} fontSize="md" me="26px" mb="40px">
                As we live, our hearts turn colder. Cause pain is what we go through as we become older. We get insulted by others, lose trust for those others. We get back stabbed
                by friends. It becomes harder for us to give others a hand. We get our heart broken by people we love, even that we give them all...
            </Text>
            <SimpleGrid columns={2} gap="20px">
                ...
                <Information boxShadow={cardShadow} title="Organization" value="AbiolaSoft Web LLC" />
