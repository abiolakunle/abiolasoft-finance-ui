...
export default function SidebarDocs() {
    ...
    return (
        <Flex justify="center" direction="column" align="center" bg={bgColor} borderRadius="30px" me={{ base: "20px" }} position="relative">
            <Flex
                border="5px solid"
            ...
            <Flex direction="column" mb="12px" align="center" justify="center" px="15px" pt="55px">
                <Text fontSize={{ base: "lg", xl: "18px" }} color="white" fontWeight="bold" lineHeight="150%" textAlign="center" px="10px" mb="14px">
                    Upgrade to PRO
                </Text>
