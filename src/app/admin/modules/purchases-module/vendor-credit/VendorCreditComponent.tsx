...
const VendorCreditComponent = () => {
    const { id, organizationId } = useParams();

    const redirect = `/admin/organizations/${organizationId}/modules/purchases/vendor-credits/`;
        ...
        <>
            ...
            >
                ...
                <Flex
                    ...
                    gap="20px"
                >
                    <IfUserIsPermitted to="Edit Vendor Credit">
                        <ChakraLink
                            order={{ sm: "1" }}
                            as={ReactRouterLink}
                            to={`/admin/organizations/${organizationId}/modules/purchases/vendor-credits/${id}/edit`}
                        >
                    ...
                    <Menu>
                        ...
                        <MenuList>
                            <IfUserIsPermitted to="Delete Vendor Credit">
                    ...
                    <ChakraLink
                        order={{ sm: "3", md: "4" }}
                        as={ReactRouterLink}
                        to={`/admin/organizations/${organizationId}/modules/purchases/vendor-credits`}
                    >
                        <CloseButton size="lg" />
                    </ChakraLink>
                </Flex>
...
export default VendorCreditComponent;
