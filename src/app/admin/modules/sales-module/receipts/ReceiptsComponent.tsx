...
import { ReceiptsTableComponent } from "./ReceiptsTableComponent";
...
const ReceiptsComponent = () => {
    ...
    useEffect(() => {
        axiosRequest
            .get(`Sales/GetAllReceipts?PageIndex=${pageIndex}&PageSize=${pageSize}`)
            .then((response) => {
    ...
    return (
        <>
            <Flex
                ...
                gap="20px"
            >
                <IfUserIsPermitted to="Create Receipt">
                    <ChakraLink as={ReactRouterLink} to={`/admin/organizations/${organizationId}/modules/sales/receipts/new`}>
            ...
            <Box pt={{ base: "16px", md: "16px", xl: "16px" }}>
                <SimpleGrid columns={{ base: 1, md: 1, xl: 1 }} gap="20px" mb="20px">
                    {data && <ReceiptsTableComponent tableData={data} />}
                </SimpleGrid>
            </Box>
