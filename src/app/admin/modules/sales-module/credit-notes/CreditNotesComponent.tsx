...
import CreditNotesTableComponent from "./CreditNotesTableComponent";
...
const CreditNotesComponent = () => {
    ...
    useEffect(() => {
        axiosRequest
            .get(`Sales/GetAllCreditNotes?PageIndex=${pageIndex}&PageSize=${pageSize}`)
            .then((response) => {
        ...
        <>
            ...
            <Box pt={{ base: "16px", md: "16px", xl: "16px" }}>
                <SimpleGrid columns={{ base: 1, md: 1, xl: 1 }} gap="20px" mb="20px">
                    {data && <CreditNotesTableComponent tableData={data} />}
                </SimpleGrid>
            </Box>
